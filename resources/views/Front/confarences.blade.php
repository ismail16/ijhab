                        ...
                        <div class="feature-box-wrapper">
                            <div class="feature-img">
                                <a class="readmore-btn readmore"
                                    href="{{ url('confarences-details/' . $item->confarence_id) }}">
                                    <span><img src="{{ asset('slider_image/confarence/' . $item->image) }}"
                            ...
                            <div class="feature-content">
                                ...
                                <a class="readmore-btn readmore"
                                    href="{{ url('confarences-details/' . $item->confarence_id) }}">Read more</a>
