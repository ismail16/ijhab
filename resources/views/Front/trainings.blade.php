                    ...
                    <div class="col-lg-4">
                        <div class="feature-box-wrapper">
                            <div class="feature-img">
                                <a class="readmore-btn readmore" href="{{ url('trainings-details/' . $item->traning_id) }}">
                                    <span><img src="{{ asset('slider_image/traning/' . $item->image) }}"
                            ...
                            <div class="feature-content">
                                ...
                                <a class="readmore-btn readmore"
                                    href="{{ url('trainings-details/' . $item->traning_id) }}">Read more</a>
