<div id="tl-site-top" class="tl-site-top">
  ...
  <header id="tl-header" class="tl-header">
      ...
      <div class="container">
      <a href="{{url('/')}}"><img src="{{asset('asset_front/images/logos/logo.png')}}" alt="" class="responsive; importent!"></a>
    </div>
    </div>
          ...
          <div class="collapse navbar-collapse justify-content-start" id="navbarSupportedContent">
            <ul class="navbar-nav ">
              ...
              <li class="nav-item dropdown">
                ...
                <li class="nav-item"><a href="{{url('publication-place')}}">Place of Publication</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <li class="nav-item"><a href="{{url('submissionguidelines')}}">Submission Guidelines</a></li>
                <li class="nav-item"><a href="{{url('submissionsteps')}}">Submission Steps</a></li>
                <li class="nav-item"><a href="{{url('template')}}">Template</a></li>
                <li class="nav-item"><a href="{{url('payment')}}">Payment</a></li>

                </ul>
              </li><!-- li end-->
                <li class="nav-item dropdown"><a class="nav-link" href="{{url('#')}}">Archive</a></li><!-- li end-->
                <li class="nav-item dropdown"><a class="nav-link" href="{{url('#')}}">Indexing</a></li><!-- li end-->
              <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown"><a class="nav-link" href="{{url('aboutus')}}">About Us</a></li><!-- li end-->
            <li class="nav-item dropdown"><a class="nav-link" href="{{url('contacts')}}">Contact Us</a></li><!-- li end-->
          </ul>
            <!--Nav ul end-->
