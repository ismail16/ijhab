        ...
        <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form method="POST" action="{{ url('workshop') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-8">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">workshop Details</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                                            ...
                                            @foreach ($result as $item)
                                                <tr>
                                                    <td><a style="color:blue;text-decoration: underline"
                                                            href="{{ url('workshop/' . $item->workshop_id . '/edit') }}">{{ $item->title }}</a>
                                                    </td>
                                                    <td>
                                                        {{ \Illuminate\Support\Str::limit($item->details, 50, '...') }}
                                                    </td>
                                                    <td>{{ date('Y-m-d h:i:s a', strtotime($item->event_date)) }}</td>
                                                    <td>
                                                        <img src="{{ asset('slider_image/workshop/' . $item->image) }}"
                                                            width="100%" alt="{{ $item->image }}">
                                                    </td>
                                                    <td>{{ $item->status }}</td>
                                                    <td><a href="{{ url('delet_workshop/' . $item->workshop_id) }}"><i
