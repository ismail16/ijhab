    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">conference Edit</h5>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form method="POST" action="{{ url('confarence/' . $result->confarence_id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <img src="{{ asset('slider_image/confarence/' . $result->image) }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class='input-group date' id='datetimepicker1'>
                                                        <input type='text' class="form-control" name="confarence_date"
                                                            value="{{ date('m/d/Y h:i:s a', strtotime($result->confarence_date)) }}" />
