        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Advisors Form</h6>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form method="POST" action="{{ url('director') }}" enctype="multipart/form-data">

                                            @csrf
                                            <div class="form-group">
                                                <label class="control-label mb-10" for="exampleInputuname_1">Advisors
                                                    Name</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="icon-user"></i>
                                                    </div>
                                                    <input type="text" class="form-control" id="exampleInputuname_1"
                                                        placeholder="Advisors Name" name="name"
                                                        autocomplete="new-password">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label mb-10"
                                                    for="exampleInputEmail_1">image(150x150)</label>
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label mb-10" for="exampleInputpwd_2">
                                                    Designation</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="icon-user-following"></i>
                                                    </div>
                                                    <input type="text" class="form-control" name="degignation">
                                                </div>
                                            </div>
            ...
            <div class="col-md-8">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">director Details</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                                    ...
                                    <table id="datable_1" class="table table-hover display  pb-30">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:16.6%;">Designation</th>
                                            ...
                                            @foreach ($result as $item)
                                                <tr>
                                                    <td><a style="color:blue;text-decoration: underline"
                                                            href="{{ url('director/' . $item->director_id . '/edit') }}">{{ $item->name }}</a>
                                                    </td>
                                                    <td>{{ $item->degignation }}</td>
                                                    <td>
                                                        <img src="{{ asset('slider_image/director/' . $item->image) }}"
                                                            width="20%" alt="{{ $item->image }}">
                                                    </td>
                                                    <td>{{ $item->status }}</td>
                                                    <td><a href="{{ url('delet_director/' . $item->director_id) }}"><i
