                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="form-wrap">
                                            <form method="POST" action="{{ url('save_archive') }}" enctype="multipart/form-data">
                                                ...
                                                @csrf
                                                    ...
                                                    <div class="row">
                                                       ...
                                                       <select name="month" class="form-control">
                                                           ...
                                                           <option value="{{$val->id}}">{{$val->month_name}}</option>
                                                           @endforeach
                                                       </select>
                                                        </div>
                                                    <div class="col-md-6">
                                                            ...
                                                            <label class="control-label mb-10"
                                                                ...
                                                                <select name="year" class="form-control">
                                                                    ...
                                                                    <option value="{{$val->id}}">{{$val->years_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                        </div>
                                                    </div>
