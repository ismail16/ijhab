        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Traning Form</h6>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form method="POST" action="{{ url('traning') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class='input-group date' id='datetimepicker1'>
                                                        <input type='text' class="form-control" name="traning_date"
                                                            required />
            ...
            <div class="col-md-8">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">traning Info</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                                            ...
                                            @foreach ($result as $item)
                                                <tr>
                                                    <td><a style="color:blue;text-decoration: underline"
                                                            href="{{ url('traning/' . $item->traning_id . '/edit') }}">{{ $item->title }}</a>
                                                    </td>
                                                    <td>
                                                        {{ \Illuminate\Support\Str::limit($item->details, 50, '...') }}
                                                    </td>
                                                    <td>{{ date('Y-m-d h:i:s a', strtotime($item->traning_date)) }}</td>
                                                    <td>
                                                        <img src="{{ asset('slider_image/traning/' . $item->image) }}"
                                                            width="100%" alt="{{ $item->image }}">
                                                    </td>
                                                    <td>{{ $item->status }}</td>
                                                    <td><a href="{{ url('delet_traning/' . $item->traning_id) }}"><i
