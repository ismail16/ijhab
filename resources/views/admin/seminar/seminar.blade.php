                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">Seminar Form</h6>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputuname_1" placeholder="Title" name="title" autocomplete="new-password" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label mb-10"
                                                            for="exampleInputEmail_1">image (700x400)</label>
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i
                                                                    class="icon-cloud-upload"></i></div>
                                                            <input type="file" class="form-control"
                                                                id="exampleInputEmail_1" name="image" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label mb-10"
                                                            for="exampleInputpwd_2"> Details</label>
                                                            <div class="input-group">
                    ...
                    <div class="col-md-8">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">Seminar Info</h6>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-wrapper collapse in">
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
                                                    <td><a style="color:blue;text-decoration: underline" href="{{url('seminar/'.$item->seminar_id.'/edit')}}">{{$item->title}}</a></td>
                                                    <td>
                                                        {{ \Illuminate\Support\Str::limit($item->details, 50, '...') }}
                                                        </td>
                                                    <td>{{date("Y-m-d h:i:s a",strtotime($item->seminar_date))}}</td>
                                                        <td>
                                                        <img src="{{asset('slider_image/seminar/'.$item->image)}}" width="100%" alt="{{$item->image}}">
                                                        </td>
                                                        <td>{{$item->status}}</td>
                                                    <td><a href="{{url('delet_seminar/'.$item->seminar_id)}}"><i class="btn btn-danger fa fa-trash"></i></a></td>
                                                    </tr>
                                                    @endforeach
