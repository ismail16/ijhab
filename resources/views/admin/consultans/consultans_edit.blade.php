    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Consultants Edit</h5>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form method="POST" action="{{ url('consaltans/' . $result->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <img src="{{ asset('slider_image/consultans/' . $result->image) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea name="info" id="" cols="30" rows="10" class="form-control">{{ $result->info }}</textarea>
